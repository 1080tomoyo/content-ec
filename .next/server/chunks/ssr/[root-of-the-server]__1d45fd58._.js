module.exports = [
"[project]/.next-internal/server/app/books/[bookSlug]/[chapterSlug]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/components/user-avatar.tsx [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/components/sign-in-button.tsx [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/books/[bookSlug]/[chapterSlug]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/components/user-avatar.tsx [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/components/sign-in-button.tsx [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/supabase/utils.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createPurchaseRecord({ userIdentifier, contentId, paymentIntentId, amount }) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("purchases").insert({
...
async function checkUserPurchase(userIdentifier, contentId) {
    try {
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("purchases").select("id").eq("user_identifier", userIdentifier).eq("content_id", contentId).maybeSingle();
        return !!data;
    } catch (error) {
...
async function checkAccessAndRedirect(contentId, contentType) {
    ...
    if (!session?.user) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])("/api/auth/signin");
    // 購入の確認
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase/utils.ts [app-rsc] (ecmascript)");
;
;
;
;
...
async function ChapterPage({ params }) {
    ...
    if (book.isPaid) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkAccessAndRedirect"])(book.id, "book");
    }
    // データ一覧から、現在のチャプターを探す
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d45fd58._.js.map